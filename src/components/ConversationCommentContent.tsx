...
import { processCommentContent } from "../utils/conversationUtils";
...
interface ConversationCommentContentProps {
  comment: Comment;
}

export default function ConversationCommentContent({ comment }: ConversationCommentContentProps) {
