      ...
      <div className="w-full h-full flex flex-col">
        <div className="flex items-center justify-center h-full">
          <div className="text-center">
            ...
            <h2 className="text-h6 text-logoWhite mb-2 font-heading">Loading Conversation...</h2>
            <p className="text-darkWhite text-sm font-body">
              Fetching comments for {ticketCode}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="space-y-4">
          {comments.length === 0 ? (
            ...
            comments.map((comment) => (
              <div
                key={comment.id}
                className="bg-white bg-opacity-5 backdrop-blur-sm rounded-lg p-4 border border-gray-600"
              >
